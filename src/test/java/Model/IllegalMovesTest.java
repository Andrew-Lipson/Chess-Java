...
public class IllegalMovesTest {
    ...
    public void kingInCheckTest1(int file){
        ...
        ArrayList<Position> actualMoves = Moves.chooseMove(new Position(file,3),game);
    ...
    public void kingLimitedMovesTest2(){
        ...
        ArrayList<Position> actualMoves = Moves.chooseMove(new Position(7,0),game);
        checkForCorrectPositions(actualMoves, expectedMoves);
    }
    ...
    public void queenStopCheckMovesTest1(){
        ...
        ArrayList<Position> actualMoves = Moves.chooseMove(new Position(5,1),game);
        checkForCorrectPositions(actualMoves, expectedMoves);
    }
    ...
    public void knightStopCheckMovesTest1(){
        ...
        int[][] expectedMoves = new int[][] {{7,3},{3,3}};
        ArrayList<Position> actualMoves = Moves.chooseMove(new Position(5,2),game);
        checkForCorrectPositions(actualMoves, expectedMoves);
    }
    ...
    public void pawnStopCheckMovesTest1(){
        ...
        ArrayList<Position> actualMoves = Moves.chooseMove(new Position(6,1),game);
        checkForCorrectPositions(actualMoves, expectedMoves);
    }
    ...
    public void rookStopCheckMovesTest1(){
        ...
        ArrayList<Position> actualMoves = Moves.chooseMove(new Position(3,2),game);
        checkForCorrectPositions(actualMoves, expectedMoves);
    }
    ...
    public void queenPinnedMovesTest1(){
        ...
        ArrayList<Position> actualMoves = Moves.chooseMove(new Position(3,6),game);
        checkForCorrectPositions(actualMoves, expectedMoves);
    }
